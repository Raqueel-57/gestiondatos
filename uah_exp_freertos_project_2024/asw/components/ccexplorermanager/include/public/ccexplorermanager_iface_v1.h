#ifndef CCEXPLORERMANAGER_H_
#define CCEXPLORERMANAGER_H_
 ...
 *
 */
class CCExplorerManager: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMCCExplorerManagerSignal
	...
	/**
	 * \class CCExplorerManager::CEDROOMMemory
	...
	//! GuidanceCtrl Component Port
	CEDROOMInterface	GuidanceCtrl;
	...
	//! Constructor
	CCExplorerManager(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
...
public:
	...
	enum TEDROOMCCExplorerManagerSignal { EDROOMSignalTimeout,
		...
		friend class CCExplorerManager;

		//!component reference
		CCExplorerManager &EDROOMcomponent;
		...
		//!Constructor
		EDROOM_CTX_Top_0 (CCExplorerManager &act,
	...
	public:
		...
		//! Constructor
		EDROOM_SUB_Top_0 (CCExplorerManager &act, CEDROOMMemory *pEDROOMMemory  );
