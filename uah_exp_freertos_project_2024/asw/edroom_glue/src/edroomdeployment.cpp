...
TEDROOMSignal CEDROOMSystemCommSAP::C6Guidance_PGuidanceCtrl__C2ExplorerManager_PGuidanceCtrl(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C2ExplorerManager_PGuidanceCtrl__C6Guidance_PGuidanceCtrl(TEDROOMSignal signalOut){
...
void CEDROOMSystemCommSAP::RegisterInterfaces(){
	...
	m_localCommSAP.RegisterInterface(1, mp_comp2->GuidanceCtrl, mp_comp2);
	...
	m_localCommSAP.RegisterInterface(2, mp_comp6->GuidanceCtrl, mp_comp6);
	m_localCommSAP.RegisterInterface(3, mp_comp6->TMChannelCtrl, mp_comp6);
...
void CEDROOMSystemCommSAP::SetLocalConnections(){
	...
	m_localCommSAP.Connect(mp_comp6->GuidanceCtrl, mp_comp2->GuidanceCtrl, connections[0], 
					C6Guidance_PGuidanceCtrl__C2ExplorerManager_PGuidanceCtrl, 
					C2ExplorerManager_PGuidanceCtrl__C6Guidance_PGuidanceCtrl);
