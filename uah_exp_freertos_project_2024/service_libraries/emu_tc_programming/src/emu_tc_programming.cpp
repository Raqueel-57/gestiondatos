...
#define FT_UAH_EXP_SERV_129_0030
...
/* EmuGSS_TCProgram3_5 prog_FT_0050_step_2(FT_SOLO_EPD_ICU_SERV_3_0050_TIME_step1,
		"FT_SOLO_EPD_ICU_SERV_3_0050 step 2, Enable SID 10 ",10); */


#endif

#ifdef FT_UAH_EXP_SERV_129_0030


EmuGSS_TCProgram129_1 prog_FT_0030_step_0(UNITIME_AFTER_POWER_ON + 50,
					"FT_UAH_EXP_SERV_129_00XX step 0, Set Kp", 0.2, 0.2);

EmuGSS_TCProgram129_2 prog_FT_0030_step_1(UNITIME_AFTER_POWER_ON + 60,
